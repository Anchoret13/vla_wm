        ...
        "causal_reacquisition": (
            {
                ...
                "evidence_gate_rule": (
                    ...
                    "requires current-frame SIFT+SAM agreement or at most one-frame-old collision-free "
                    "SIFT+SAM identity evidence with a currently reliable basket and mask-centroid displacement "
                    "no larger than the last verified mask-bbox diagonal, otherwise raw label is uncertain"
                ),
            ...
            "causal_reacquisition": (
                {
                    ...
                    "reprompt_min_displacement_px": TEMPORAL_REPROMPT_MIN_DISPLACEMENT_PX,
                    ...
                    "evidence_state_gate": (
                        ...
                        "collision-free SIFT+SAM evidence from the immediately previous sampled frame "
