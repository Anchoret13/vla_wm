...
`plan_and_progress/archive/daily/2026-07-29.md`, H7 record; fixed before this run).
...
def main() -> None:
    ...
    (OUT / "collection_manifest.json").write_text(json.dumps({
        ...
        "registered": "plan_and_progress/archive/daily/2026-07-29.md H7.2 registration",
    }, indent=2))
